...
def Weight_Loss(age,weight,height):
    ...
    food_timing = st.text_input(label="Food Timing", help="Enter 1 for Breakfast, 2 for Lunch, and 3 for Dinner")
...
#age = Entry(main_win,bg="light grey")
#weight = Entry(main_win,bg="light grey")
#height = Entry(main_win,bg="light grey")
#age.focus_force() 
...
def main():
    ...
    # Widgets for input
    age = st.number_input("Enter your age", min_value=1, max_value=150, value=30)
    weight = st.number_input("Enter your weight (kg)", min_value=1.0, max_value=500.0, value=60.0)
    height = st.number_input("Enter your height (m)", min_value=1.0, max_value=300.0, value=170.0)

    # Buttons to trigger recommendation functions
    if st.button("Weight Loss"):
        Weight_Loss(age,weight,height)
    
    if st.button("Weight Gain"):
        Weight_Gain(age,weight,height)
    
    if st.button("Healthy"):
        Healthy(age,weight,height)
