...
def main():
    ...
    # Randomly select 2-3 items for breakfast, lunch, and dinner
    breakfast_items = filtered_df[filtered_df["Meal Type"] == "Breakfast"].sample(n=random.randint(2, 3))
    lunch_items = filtered_df[filtered_df["Meal Type"] == "Lunch"].sample(n=random.randint(2, 3))
    dinner_items = filtered_df[filtered_df["Meal Type"] == "Dinner"].sample(n=random.randint(2, 3))
